...
AngleStyle(harmonic/omega/alternate,AngleHarmonicOmegaAlternate)

#else

#ifndef LMP_ANGLE_OMEGA_ALTERNATE_H
#define LMP_ANGLE_OMEGA_ALTERNATE_H
...
class AngleHarmonicOmegaAlternate : public Angle {
 public:
  AngleHarmonicOmegaAlternate(class LAMMPS *);
  virtual ~AngleHarmonicOmegaAlternate();
