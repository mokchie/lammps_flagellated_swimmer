...
void NBinStandard::setup_bins(int style)
{
  ...
  if (triclinic == 0) {
    if (comm->user_part){
      bsubboxlo[0] = domain->sublo[0] - comm->bin_ext[0]*comm->bin_size[0];
      bsubboxlo[1] = domain->sublo[1] - comm->bin_ext[1]*comm->bin_size[1];
      bsubboxlo[2] = domain->sublo[2] - comm->bin_ext[2]*comm->bin_size[2];
      bsubboxhi[0] = domain->subhi[0] + comm->bin_ext[0]*comm->bin_size[0];
      bsubboxhi[1] = domain->subhi[1] + comm->bin_ext[1]*comm->bin_size[1];
      bsubboxhi[2] = domain->subhi[2] + comm->bin_ext[2]*comm->bin_size[2];
    } else {
