...
PairStyle(sdpd/angm,PairSDPDANGM)

#else

#ifndef LMP_PAIR_SDPDANGM_H
#define LMP_PAIR_SDPDANGM_H

#include "pair.h"

namespace LAMMPS_NS {

class PairSDPDANGM : public Pair {
 public:
  PairSDPDANGM(class LAMMPS *);
  virtual ~PairSDPDANGM();
