...
PairStyle(sdpdve/no/edyn/2d,PairSDPDVENoEdyn2D)

#else

#ifndef LMP_PAIR_SDPD_VE_NO_EDYN_2D_H
#define LMP_PAIR_SDPD_VE_NO_EDYN_2D_H

#include "pair.h"

namespace LAMMPS_NS {

class PairSDPDVENoEdyn2D : public Pair {
 public:
  PairSDPDVENoEdyn2D(class LAMMPS *);
  virtual ~PairSDPDVENoEdyn2D();
