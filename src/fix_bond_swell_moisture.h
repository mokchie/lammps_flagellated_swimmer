...
FixStyle(bond/swell/moisture,FixBondSwellMoisture)

#else

#ifndef LMP_FIX_BOND_SWELL_MOISTURE_H
#define LMP_FIX_BOND_SWELL_MOISTURE_H

#include "fix.h"

namespace LAMMPS_NS {

class FixBondSwellMoisture : public Fix {
 public:
  FixBondSwellMoisture(class LAMMPS *, int, char **);
  ~FixBondSwellMoisture();
  int setmask();
  void init();
  void post_integrate();
