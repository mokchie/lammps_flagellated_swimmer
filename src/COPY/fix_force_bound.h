...
class FixForceBound : public Fix {
 ...
 private:
  ...
  int nbinx, nbiny, nbinz, nbin, bin_max_shape, bin_max_vertex;
  tagint ntri_tot, min_ind, max_ind, npart_tot;
  tagint **tri_tags, *tri_mol, **part_tri, *part_list, *tri_list;
  double **x_part, **v_part, **v_delt, *mol_mass, **f_part;
  ...
  int maxneed[3];  
  int size_border, size_forward, size_reverse;
