...
class FixForceBound2D : public Fix {
 ...
 private:
  ...
  int nbond, npart, max_npart, max_nbond, npart_loc;
  ...
  int nbinx, nbiny, nbin, bin_max_shape, bin_max_vertex;
  tagint nbond_tot, min_ind, max_ind, npart_tot;
  tagint **bond_tags, *bond_mol, **part_bond, *part_list, *bond_list;
  double **x_part, **v_part, **v_delt, *mol_mass;
