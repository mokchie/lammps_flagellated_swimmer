...
ComputeStyle(group/group/bondc,ComputeGroupGroupBondc)

#else

#ifndef LMP_COMPUTE_GROUP_GROUP_BONDC_H
#define LMP_COMPUTE_GROUP_GROUP_BONDC_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeGroupGroupBondc : public Compute {
 public:
  ComputeGroupGroupBondc(class LAMMPS *, int, char **);
  ~ComputeGroupGroupBondc();
  void init();
