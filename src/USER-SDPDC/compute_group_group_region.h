...
ComputeStyle(group/group/region,ComputeGroupGroupRegion)

#else

#ifndef LMP_COMPUTE_GROUP_GROUP_REGION_H
#define LMP_COMPUTE_GROUP_GROUP_REGION_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeGroupGroupRegion : public Compute {
 public:
  ComputeGroupGroupRegion(class LAMMPS *, int, char **);
  ~ComputeGroupGroupRegion();
  void init();
