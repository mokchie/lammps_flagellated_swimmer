...
PairStyle(sdpd/mc,PairSDPDMC)

#else

#ifndef LMP_PAIR_SDPDMC_H
#define LMP_PAIR_SDPDMC_H

#include "pair.h"

namespace LAMMPS_NS {

class PairSDPDMC : public Pair {
 public:
  PairSDPDMC(class LAMMPS *);
  virtual ~PairSDPDMC();
