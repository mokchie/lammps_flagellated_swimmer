...
PairStyle(gran/hooke/history/swelling,PairGranHookeHistorySwelling)

#else

#ifndef LMP_PAIR_GRAN_HOOKE_HISTORY_SWELLING_H
#define LMP_PAIR_GRAN_HOOKE_HISTORY_SWELLING_H

#include "pair.h"

namespace LAMMPS_NS {

class PairGranHookeHistorySwelling : public Pair {
 public:
  PairGranHookeHistorySwelling(class LAMMPS *);
  virtual ~PairGranHookeHistorySwelling();
 ...
 protected:
  ...
  double tstart,tend,swelling_ratio;
