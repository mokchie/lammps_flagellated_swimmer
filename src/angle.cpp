...
void Angle::ev_tally2(int i, int j, int k, int nlocal, int newton_bond,
                     double eangle, double **fa, double **fv, double vv,
                     double d21x, double d21y, double d21z, double d31x, double d31y, double d31z, 
                     double d32x, double d32y, double d32z)
{
  double eanglethird,v[6];
  ...
  if (vflag_either) {
    v[0] = d21x*fa[1][0] + d31x*fa[2][0] + (d21x*(fv[1][0]-fv[0][0]) + d31x*(fv[2][0]-fv[0][0]) + d32x*(fv[2][0]-fv[1][0]))*THIRD + vv;
    v[1] = d21y*fa[1][1] + d31y*fa[2][1] + (d21y*(fv[1][1]-fv[0][1]) + d31y*(fv[2][1]-fv[0][1]) + d32y*(fv[2][1]-fv[1][1]))*THIRD + vv;
    v[2] = d21z*fa[1][2] + d31z*fa[2][2] + (d21z*(fv[1][2]-fv[0][2]) + d31z*(fv[2][2]-fv[0][2]) + d32z*(fv[2][2]-fv[1][2]))*THIRD + vv;
    v[3] = d21x*fa[1][1] + d31x*fa[2][1] + (d21x*(fv[1][1]-fv[0][1]) + d31x*(fv[2][1]-fv[0][1]) + d32x*(fv[2][1]-fv[1][1]))*THIRD;
    v[4] = d21x*fa[1][2] + d31x*fa[2][2] + (d21x*(fv[1][2]-fv[0][2]) + d31x*(fv[2][2]-fv[0][2]) + d32x*(fv[2][2]-fv[1][2]))*THIRD;
    v[5] = d21y*fa[1][2] + d31y*fa[2][2] + (d21y*(fv[1][2]-fv[0][2]) + d31y*(fv[2][2]-fv[0][2]) + d32y*(fv[2][2]-fv[1][2]))*THIRD;
