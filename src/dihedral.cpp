...
void Dihedral::ev_tally2(int i1, int i2, int i3, int i4,
                        int nlocal, int newton_bond,
                        double edihedral, double *f1, double *f2, double *f4,
                        double d31x, double d31y, double d31z,
                        double d32x, double d32y, double d32z,
                        double d34x, double d34y, double d34z)
{
  double edihedralquarter,v[6];
  ...
  if (vflag_either) {
    v[0] = -d31x*f1[0] - d32x*f2[0] - d34x*f4[0];
    v[1] = -d31y*f1[1] - d32y*f2[1] - d34y*f4[1];
    v[2] = -d31z*f1[2] - d32z*f2[2] - d34z*f4[2];
    v[3] = -d31x*f1[1] - d32x*f2[1] - d34x*f4[1];
    v[4] = -d31x*f1[2] - d32x*f2[2] - d34x*f4[2];
    v[5] = -d31y*f1[2] - d32y*f2[2] - d34y*f4[2];
