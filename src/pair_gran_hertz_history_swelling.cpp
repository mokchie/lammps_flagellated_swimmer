...
PairGranHertzHistorySwelling::PairGranHertzHistorySwelling(LAMMPS *lmp) :
  PairGranHookeHistorySwelling(lmp) {}

/* ---------------------------------------------------------------------- */

void PairGranHertzHistorySwelling::compute(int eflag, int vflag)
{
...
void PairGranHertzHistorySwelling::settings(int narg, char **arg)
{
...
double PairGranHertzHistorySwelling::single(int i, int j, int /*itype*/, int /*jtype*/,
                                    double rsq,
