...
PairStyle(sdpdve/no/edyn,PairSDPDVENoEdyn)

#else

#ifndef LMP_PAIR_SDPD_VE_NO_EDYN_H
#define LMP_PAIR_SDPD_VE_NO_EDYN_H

#include "pair.h"

namespace LAMMPS_NS {

class PairSDPDVENoEdyn : public Pair {
 public:
  PairSDPDVENoEdyn(class LAMMPS *);
  virtual ~PairSDPDVENoEdyn();
