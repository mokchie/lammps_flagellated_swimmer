...
#include <cmath>
#include "fix_wall_lj126_measure.h"
#include <iostream>
#include <mpi.h>
...
FixWallLJ126Measure::FixWallLJ126Measure(LAMMPS *lmp, int narg, char **arg) :
  FixWallMeasure(lmp, narg, arg) {
...
void FixWallLJ126Measure::precompute(int m)
{
...
double FixWallLJ126Measure::wall_particle(int m, int which, double coord)
{
