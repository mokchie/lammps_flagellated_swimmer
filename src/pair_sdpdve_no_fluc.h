...
PairStyle(sdpdve/no/fluc,PairSDPDVENoFluc)

#else

#ifndef LMP_PAIR_SDPD_VE_NO_FLUC_H
#define LMP_PAIR_SDPD_VE_NO_FLUC_H

#include "pair.h"

namespace LAMMPS_NS {

class PairSDPDVENoFluc : public Pair {
 public:
  PairSDPDVENoFluc(class LAMMPS *);
  virtual ~PairSDPDVENoFluc();
