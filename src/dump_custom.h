...
class DumpCustom : public Dump {
 ...
 protected:
  ...
  void pack_iy(int);
  void pack_iz(int);
  void pack_ctensor11(int);
  void pack_ctensor22(int);
  void pack_ctensor33(int);
  void pack_ctensor12(int);
  void pack_ctensor13(int);
  void pack_ctensor23(int);
  void pack_kappa11(int);
  void pack_kappa12(int);
  void pack_kappa13(int);
  void pack_kappa21(int);
  void pack_kappa22(int);
  void pack_kappa23(int);
  void pack_kappa31(int);
  void pack_kappa32(int);
  void pack_kappa33(int);
  void pack_ceigen1(int);
  void pack_ceigen2(int);
  void pack_ceigen3(int);
  void pack_vx(int);
  void pack_vy(int);
  void pack_vz(int);
  void pack_fx(int);
