...
PairStyle(dpd/thermal,PairDPDThermal)

#else

#ifndef LMP_PAIR_DPD_THERMAL_H
#define LMP_PAIR_DPD_THERMAL_H

#include "pair.h"

namespace LAMMPS_NS {

class PairDPDThermal : public Pair {
 public:
  PairDPDThermal(class LAMMPS *);
  ~PairDPDThermal();
