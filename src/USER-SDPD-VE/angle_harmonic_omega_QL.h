...
AngleStyle(harmonic/omega/QL,AngleHarmonicOmegaQL)

#else

#ifndef LMP_ANGLE_OMEGA_QL_H
#define LMP_ANGLE_OMEGA_QL_H
...
class AngleHarmonicOmegaQL : public Angle {
 public:
  AngleHarmonicOmegaQL(class LAMMPS *);
  virtual ~AngleHarmonicOmegaQL();
