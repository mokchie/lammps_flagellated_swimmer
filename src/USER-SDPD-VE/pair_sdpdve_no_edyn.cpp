...
PairSDPDVENoEdyn::PairSDPDVENoEdyn(LAMMPS *lmp) : Pair(lmp)
{
  random = NULL;
  mtrand = NULL;
...
PairSDPDVENoEdyn::~PairSDPDVENoEdyn()
{
  if (allocated) {
...
void PairSDPDVENoEdyn::compute(int eflag, int vflag)
{
...
void PairSDPDVENoEdyn::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairSDPDVENoEdyn::settings(int narg, char **arg)
{
...
void PairSDPDVENoEdyn::coeff(int narg, char **arg)
{
...
void PairSDPDVENoEdyn::init_style()
{
...
double PairSDPDVENoEdyn::init_one(int i, int j)
{
...
void PairSDPDVENoEdyn::write_restart(FILE *fp)
{
...
void PairSDPDVENoEdyn::read_restart(FILE *fp)
{
...
void PairSDPDVENoEdyn::write_restart_settings(FILE *fp)
{
...
void PairSDPDVENoEdyn::read_restart_settings(FILE *fp)
{
  long unsigned int seed2;
...
double PairSDPDVENoEdyn::single(int i, int j, int itype, int jtype, double rsq,
...
void PairSDPDVENoEdyn::generate_wrr()
{
  int i;
  double ww[3][3];
...
int PairSDPDVENoEdyn::pack_forward_comm(int n, int *list, double *buf, int pbc_flag, int *pbc)
{
  int i,j,m;
  double *rho = atom->rho;
...
void PairSDPDVENoEdyn::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
  double *rho = atom->rho;
  double ***kappa = atom->kappa;
...
int PairSDPDVENoEdyn::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
  double *rho = atom->rho;
  double ***kappa = atom->kappa;
...
void PairSDPDVENoEdyn::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
  double *rho = atom->rho;
  double ***kappa = atom->kappa;
...
void PairSDPDVENoEdyn::print_matrix( char* desc, int m, int n, double** a) {
  int i, j;
  printf( "\n %s\n", desc );
  for( i = 0; i < m; i++ ) {
