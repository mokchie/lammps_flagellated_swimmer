...
AngleHarmonicEqvar::AngleHarmonicEqvar(LAMMPS *lmp) : Angle(lmp)
{
  k = NULL;
  b = NULL;
  omega = NULL;
...
AngleHarmonicEqvar::~AngleHarmonicEqvar()
{
  if (allocated) {
...
void AngleHarmonicEqvar::compute(int eflag, int vflag)
{
  ...
  for (n = 0; n < nanglelist; n++) {
    ...
    if (cross > 0.0)
      theta = -theta;
    phi = thx + omega[type]*update->ntimestep*update->dt;
...
void AngleHarmonicEqvar::allocate()
{
  allocated = 1;
...
void AngleHarmonicEqvar::coeff(int narg, char **arg)
{
...
double AngleHarmonicEqvar::equilibrium_angle(int i)
{
  return theta0[i];
}
...
void AngleHarmonicEqvar::write_restart(FILE *fp)
{
...
void AngleHarmonicEqvar::read_restart(FILE *fp)
{
  allocate();
...
void AngleHarmonicEqvar::write_data(FILE *fp)
{
...
double AngleHarmonicEqvar::single(int type, int i1, int i2, int i3)
{
  double **x = atom->x;
...
double AngleHarmonicEqvar::shiftmap(double x, double a0, double b0, double a, double b)
{
