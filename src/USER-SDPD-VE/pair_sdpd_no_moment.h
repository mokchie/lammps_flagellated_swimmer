...
PairStyle(sdpd/no/moment,PairSDPDNoMoment)

#else

#ifndef LMP_PAIR_SDPD_NO_MOMENT_H
#define LMP_PAIR_SDPD_NO_MOMENT_H

#include "pair.h"

namespace LAMMPS_NS {

class PairSDPDNoMoment : public Pair {
 public:
  PairSDPDNoMoment(class LAMMPS *);
  virtual ~PairSDPDNoMoment();
