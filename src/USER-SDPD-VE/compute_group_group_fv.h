...
ComputeStyle(group/group/fv,ComputeGroupGroupFV)

#else

#ifndef LMP_COMPUTE_GROUP_GROUP_FV_H
#define LMP_COMPUTE_GROUP_GROUP_FV_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeGroupGroupFV : public Compute {
 public:
  ComputeGroupGroupFV(class LAMMPS *, int, char **);
  ~ComputeGroupGroupFV();
  void init();
 ...
 private:
  ...
  int pairflag,kspaceflag,boundaryflag,molflag,inertialflag,velocityflag,vectorflag,conseronlyflag;
  class Pair *pair;
