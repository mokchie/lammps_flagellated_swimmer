...
PairStyle(sdpdve/2d,PairSDPDVE2D)

#else

#ifndef LMP_PAIR_SDPD_VE_2D_H
#define LMP_PAIR_SDPD_VE_2D_H

#include "pair.h"

namespace LAMMPS_NS {

class PairSDPDVE2D : public Pair {
 public:
  PairSDPDVE2D(class LAMMPS *);
  virtual ~PairSDPDVE2D();
